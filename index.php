...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="MURID1.jpg"alt="...">
    </div>
    <div class="item">
      <img src="MURID2.jpg" alt="...">      
    </div>
	<div class="item">
      <img src="MURID3.jpg" alt="...">
    </div>
  </div>
...
<div class="row margin-atas">
  <div class="col-sm-6 col-md-3">
    <div class="thumbnail">
      <img src="FUTSALL.jpg" alt="Lomba Futsal" he>
      <div class="caption">
   ...
   <div class="col-sm-6 col-md-3">
    <div class="thumbnail">
      <img src="basket.jpg" alt="Lomba Basket">
      <div class="caption">
   ...
   <div class="col-sm-6 col-md-3">
    <div class="thumbnail">
      <img src="tanaman.jpg" alt="Hari Pohon Sedunia">
      <div class="caption">
    ...
    <div class="col-sm-6 col-md-3">
    <div class="thumbnail">
      <img src="voly.jpg" alt="Lomba voly">
      <div class="caption">
